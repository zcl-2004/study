...
class ServerInitializingIndicator extends dispose_1.Disposable {
    ...
    startedLoadingProject(projectName) {
        ...
        // vscode.window.setStatusBarMessage(localize('serverLoading.progress', "Initializing JS/TS language features"))
    }
    finishedLoadingProject(projectName) {
        // vscode.window.setStatusBarMessage(localize('serverLoading.progress.success', "Initializing JS/TS language features Successed"), 5000);
    }
}
