...
class DiskTypeScriptVersionProvider {
    ...
    get globalVersion() {
        var _a;
        if ((_a = this.configuration) === null || _a === void 0 ? void 0 : _a.globalTsdk) {
    ...
    getContributedVersion(source, extensionId, pathToTs) {
        try {
            ...
            // if (extension) {
            const serverPath = path.join(__dirname, "..", "..", "..", ...pathToTs, 'typescript', 'lib', 'tsserver.js');
    ...
    get localTsdkVersions() {
        var _a;
        const localTsdk = (_a = this.configuration) === null || _a === void 0 ? void 0 : _a.localTsdk;
    ...
    loadVersionsFromSetting(source, tsdkPathSetting) {
        if (path.isAbsolute(tsdkPathSetting)) {
            ...
            return [
                new versionProvider_1.TypeScriptVersion(source, serverPath, DiskTypeScriptVersionProvider.getApiVersion(serverPath))
            ];
        }
