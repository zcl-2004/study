...
exports.LessIndexProcessor = void 0;
...
class LessIndexProcessor {
    createIndexData(workspaceFolder, document) {
        ...
        if (typeof document === 'string') {
            ...
            document = vscode_languageserver_textdocument_1.TextDocument.create(document, 'less', 0, data);
        }
        let docDir = (0, path_1.dirname)(vscode_uri_1.URI.parse(document.uri).fsPath);
        let astNode = (0, vscode_css_languageservice_1.getLESSLanguageService)().parseStylesheet(document);
...
exports.LessIndexProcessor = LessIndexProcessor;
//# sourceMappingURL=lessIndexProcessor.js.map