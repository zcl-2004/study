...
interface Uni {
     ...
     */
    getStorage(options: UniNamespace.GetStorageOptions): void;
    /**
     ...
     */
    createMediaRecorder(canvas: Record<string, any>, options: UniNamespace.CreateMediaRecorderOption): UniNamespace.MediaRecorder;
    /**
     * 获取 NFC 实例
     *
     * **示例代码**
     ...
     */
    createOffscreenCanvas(): UniNamespace.OffscreenCanvas;
    /**
     * 获取实时日志管理器对象。
     *
     *
     ...
     */
    createWorker(scriptPath: string): UniNamespace.Worker;
    /**
     ...
     */
    offAppHide(callback: UniNamespace.OffAppHideCallback): void;
    /**
     * 取消监听小程序切前台事件
     *
     * 最低基础库： `2.1.2`
     ...
     */
    offAppShow(callback: UniNamespace.OffAppShowCallback): void;
    /**
     ...
     */
    offAudioInterruptionBegin(callback: UniNamespace.OffAudioInterruptionBeginCallback): void;
    /**
     * 取消监听音频中断结束事件
     *
     * 最低基础库： `2.6.2`
     ...
     */
    offAudioInterruptionEnd(callback: UniNamespace.OffAudioInterruptionEndCallback): void;
    /**
     * 取消监听低功耗蓝牙设备的特征值变化事件。
     *
     * 最低基础库： `2.9.0`
     ...
     */
    offBLEPeripheralConnectionStateChanged(callback: UniNamespace.OffBLEPeripheralConnectionStateChangedCallback): void;
    /**
     ...
     */
    offBeaconServiceChange(callback: UniNamespace.OffBeaconServiceChangeCallback): void;
    /**
     * 取消监听 iBeacon 设备更新事件
     *
     * 最低基础库： `2.8.1`
     ...
     */
    offBeaconUpdate(callback: UniNamespace.OffBeaconUpdateCallback): void;
    /**
     * 取消监听蓝牙适配器状态变化事件。
     *
     * 最低基础库： `2.9.0`
     ...
     */
    offLocalServiceDiscoveryStop(callback: UniNamespace.OffLocalServiceDiscoveryStopCallback): void;
    /**
     * 取消监听 mDNS 服务发现的事件
     *
     * 最低基础库： `2.4.0`
     ...
     */
    offLocalServiceFound(callback: UniNamespace.OffLocalServiceFoundCallback): void;
    /**
     * 取消监听 mDNS 服务离开的事件
     *
     * 最低基础库： `2.4.0`
     ...
     */
    offLocalServiceLost(callback: UniNamespace.OffLocalServiceLostCallback): void;
    /**
     * 取消监听 mDNS 服务解析失败的事件
     *
     * 最低基础库： `2.4.0`
     ...
     */
    offLocalServiceResolveFail(callback: UniNamespace.OffLocalServiceResolveFailCallback): void;
    /**
     * 取消监听实时地理位置变化事件
     *
     * 最低基础库： `2.8.1`
     ...
     */
    offLocationChange(callback: UniNamespace.OffLocationChangeCallback): void;
    /**
     * 取消监听内存不足告警事件。
     *
     * 最低基础库： `2.9.0`
     ...
     */
    offOnVoIPVideoMembersChanged(callback: UniNamespace.OffOnVoIPVideoMembersChangedCallback): void;
    /**
     * 取消监听小程序要打开的页面不存在事件
     *
     * 最低基础库： `2.1.2`
     ...
     */
    offPageNotFound(callback: UniNamespace.OffPageNotFoundCallback): void;
    /**
     * 取消监听系统主题改变事件
     *
     * 最低基础库： `2.11.0`
     ...
     */
    offThemeChange(callback: UniNamespace.OffThemeChangeCallback): void;
    /**
     ...
     */
    offUnhandledRejection(callback: UniNamespace.OffUnhandledRejectionCallback): void;
    /**
     * 用户主动截屏事件。取消事件监听。
     *
     * 最低基础库： `2.9.3`
     ...
     */
    onAppHide(callback: UniNamespace.OnAppHideCallback): void;
    /**
     ...
     */
    onAppShow(callback: UniNamespace.OnAppShowCallback): void;
    /**
     ...
     */
    onAudioInterruptionBegin(callback: UniNamespace.OnAudioInterruptionBeginCallback): void;
    /**
     ...
     */
    onAudioInterruptionEnd(callback: UniNamespace.OnAudioInterruptionEndCallback): void;
    /**
     * 监听当前外围设备被连接或断开连接事件
     *
     * 最低基础库： `2.10.3`
     ...
     */
    onBLEPeripheralConnectionStateChanged(callback: UniNamespace.OnBLEPeripheralConnectionStateChangedCallback): void;
    /**
     * 监听音乐暂停事件。
     *
     ...
     */
    onBackgroundAudioPause(callback: UniNamespace.OnBackgroundAudioPauseCallback): void;
    /**
     * 监听音乐播放事件。
     *
     ...
     */
    onBackgroundAudioPlay(callback: UniNamespace.OnBackgroundAudioPlayCallback): void;
    /**
     * 监听音乐停止事件。
     *
     ...
     */
    onBackgroundAudioStop(callback: UniNamespace.OnBackgroundAudioStopCallback): void;
    /**
     ...
     */
    onBackgroundFetchData(callback: UniNamespace.OnBackgroundFetchDataCallback): void;
    /**
     ...
     */
    onDeviceMotionChange(callback: UniNamespace.OnDeviceMotionChangeCallback): void;
    /**
     ...
     */
    onError(callback: UniNamespace.OnAppErrorCallback): void;
    /**
     * 监听获取到 Wi-Fi 列表数据事件
     *
     * 最低基础库： `1.6.0`
     ...
     */
    onGetWifiList(callback: UniNamespace.OnGetWifiListCallback): void;
    /**
     ...
     */
    onHCEMessage(callback: UniNamespace.OnHCEMessageCallback): void;
    /**
     * 监听 mDNS 服务停止搜索的事件
     *
     * 最低基础库： `2.4.0`
     ...
     */
    onLocalServiceDiscoveryStop(callback: UniNamespace.OnLocalServiceDiscoveryStopCallback): void;
    /**
     * 监听 mDNS 服务发现的事件
     *
     * 最低基础库： `2.4.0`
     ...
     */
    onLocalServiceFound(callback: UniNamespace.OnLocalServiceFoundCallback): void;
    /**
     * 监听 mDNS 服务离开的事件
     *
     * 最低基础库： `2.4.0`
     ...
     */
    onLocalServiceLost(callback: UniNamespace.OnLocalServiceLostCallback): void;
    /**
     * 监听 mDNS 服务解析失败的事件
     *
     * 最低基础库： `2.4.0`
     ...
     */
    onLocalServiceResolveFail(callback: UniNamespace.OnLocalServiceResolveFailCallback): void;
    /**
     ...
     */
    onLocationChange(callback: UniNamespace.OnLocationChangeCallback): void;
    /**
     * 监听内存不足告警事件。
     *
     ...
     */
    onOnVoIPVideoMembersChanged(callback: UniNamespace.OnOnVoIPVideoMembersChangedCallback): void;
    /**
     ...
     */
    onPageNotFound(callback: UniNamespace.OnPageNotFoundCallback): void;
    /**
     ...
     */
    onVoIPChatInterrupted(callback: UniNamespace.OnVoIPChatInterruptedCallback): void;
    /**
     ...
     */
    onVoIPChatMembersChanged(callback: UniNamespace.OnVoIPChatMembersChangedCallback): void;
    /**
     ...
     */
    onVoIPChatSpeakersChanged(callback: UniNamespace.OnVoIPChatSpeakersChangedCallback): void;
    /**
     * 监听连接上 Wi-Fi 的事件
     *
     * 最低基础库： `1.6.0`
     ...
     */
    onWifiConnected(callback: UniNamespace.OnWifiConnectedCallback): void;
    /**
     ...
     */
    startLocationUpdate(option?: UniNamespace.StartLocationUpdateOption): void;
    /**
     ...
     */
    stopLocationUpdate(option?: UniNamespace.StopLocationUpdateOption): void;
    /**
     * 停止录音。
     *
     *
