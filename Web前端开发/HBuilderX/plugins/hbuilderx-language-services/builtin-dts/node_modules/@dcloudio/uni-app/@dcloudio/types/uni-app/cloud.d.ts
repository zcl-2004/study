...
declare namespace UniCloudNamespace {
  ...
  interface Query {
     ...
     */
    groupBy(projection: string | HBuilderX.DBFieldString): Query;
    /**
     * 指定统计指标
     *
     * 文档: [http://uniapp.dcloud.io/uniCloud/jql?id=groupby](http://uniapp.dcloud.io/uniCloud/jql?id=groupby)
     */
    groupField(projection: string | HBuilderX.DBFieldString): Query;
    /**
  ...
  interface DocumentReference {
     ...
     * 文档: [http://uniapp.dcloud.io/uniCloud/jql?id=groupby](http://uniapp.dcloud.io/uniCloud/jql?id=groupby)
     */
    preField(projection: string | HBuilderX.DBFieldString): Query;
    /**
     * 指定分组依据
     *
     * 文档: [http://uniapp.dcloud.io/uniCloud/jql?id=groupby](http://uniapp.dcloud.io/uniCloud/jql?id=groupby)
  ...
  interface Database {
     ...
     */
    action(actionName: string | HBuilderX.ClientDBActionString): Database;
    /**
     * 获取云端环境变量
     *
  ...
  interface UniCloud {
     ...
     */
    importObject(objectName: string | HBuilderX.CloudObjects, importObjectOptions?: ImportObjectOptions): any;
    /**
     * 上传文件到云端
     *
     ...
     *
     * 文档: [http://uniapp.dcloud.io/uniCloud/client-sdk?id=on-response](http://uniapp.dcloud.io/uniCloud/client-sdk?id=on-response)
     */
    onResponse(callback: (result?: UniCloudResponseEvent) => void): void;
    /**
     * 移除监听云函数、云对象、clientDB的响应
     *
     * 文档: [http://uniapp.dcloud.io/uniCloud/client-sdk?id=off-response](http://uniapp.dcloud.io/uniCloud/client-sdk?id=off-response)
     */
    offResponse(callback: (result?: UniCloudResponseEvent) => void): void;
    /**
     * 监听需要登录事件
     *
     * 文档: [http://uniapp.dcloud.io/uniCloud/client-sdk?id=on-need-login](http://uniapp.dcloud.io/uniCloud/client-sdk?id=on-need-login)
    */
    onNeedLogin(callback: (result?: UniCloudNeedLoginEvent) => void): void;
    /**
     * 移除监听需要登录事件
     *
     * 文档: [http://uniapp.dcloud.io/uniCloud/client-sdk?id=off-need-login](http://uniapp.dcloud.io/uniCloud/client-sdk?id=off-need-login)
     */
    offNeedLogin(callback: (result?: UniCloudNeedLoginEvent) => void): void;
    /**
     * 监听token刷新事件
     *
     * 文档: [http://uniapp.dcloud.io/uniCloud/client-sdk?id=on-refresh-token](http://uniapp.dcloud.io/uniCloud/client-sdk?id=on-refresh-token)
    */
    onRefreshToken(callback: (result?: UniCloudRefreshTokenEvent) => void): void;
    /**
     * 移除监听token刷新事件
     *
     * 文档: [http://uniapp.dcloud.io/uniCloud/client-sdk?id=off-refresh-token](http://uniapp.dcloud.io/uniCloud/client-sdk?id=off-refresh-token)
     */
