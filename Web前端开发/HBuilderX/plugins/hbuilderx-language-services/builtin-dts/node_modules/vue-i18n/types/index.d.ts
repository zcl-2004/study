...
declare class VueI18n {
  ...
  t(key: VueI18n.Path | HBuilderX.VueI18NKeyString, values?: VueI18n.Values): VueI18n.TranslateResult;
  t(key: VueI18n.Path | HBuilderX.VueI18NKeyString, locale: VueI18n.Locale, values?: VueI18n.Values): VueI18n.TranslateResult;
  tc(key: VueI18n.Path | HBuilderX.VueI18NKeyString, choice?: VueI18n.Choice, values?: VueI18n.Values): string;
  tc(key: VueI18n.Path | HBuilderX.VueI18NKeyString, choice: VueI18n.Choice, locale: VueI18n.Locale, values?: VueI18n.Values): string;
  te(key: VueI18n.Path | HBuilderX.VueI18NKeyString, locale?: VueI18n.Locale): boolean;
