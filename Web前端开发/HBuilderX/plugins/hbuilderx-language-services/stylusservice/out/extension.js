...
function activate(context) {
    ...
    // color
    const colorProvider = new color_provider_1.StylusColorProvider();
    ...
    //  definition
    const definitionProvider = new definitionProvider_1.StylusDefinitionProvider();
    const definitionProviderDisposable = vscode.languages.registerDefinitionProvider(DOCUMENT_SELECTOR, definitionProvider);
